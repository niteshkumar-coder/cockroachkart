...
export default function AuthPage({ setScreen, onLoginSuccess }: AuthPageProps) {
  ...
  const handleGoogleSignInByPopup = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        let serverErrorMsg = "Handshake connection timed out. Please execute again.";
        try {
          const errBody = await response.json();
          if (errBody && errBody.error) {
            serverErrorMsg = `Server error: ${errBody.error}`;
          }
        } catch (_) {}
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="relative flex py-2 items-center">
                  ...
                  <span className="flex-shrink mx-3 text-[9px] text-zinc-600 font-mono uppercase">OR</span>
                  <div className="flex-grow border-t border-neutral-900"></div>
                </div>
